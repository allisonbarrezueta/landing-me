    ...
    return (
        <section id="about-me" className="pb-16 relative pt-32 w-full">
            ...
            <div className="container px-5 py-24 mx-auto flex flex-wrap items-center">
                <div className="w-full rounded-lg border-primary-600 my-2 md:my-0 border-b border-l p-4 md:p-0 md:w-1/3 md:border-0 md:rounded-none">
                    <p className="dark:text-white text-primary-800 text-2xl text-right leading-10">
                        Hey there! I&apos;m Allison Barrezueta, a frontend
                        developer passionate about crafting immersive user
                        experiences. With a Bachelor&apos;s degree in Computer
                        Science and Economics from ESPOL university, I&apos;ve
                        honed my skills in HTML5, CSS3, JavaScript (ES6+), and
                ...
                <div className="w-full rounded-lg border-primary-600 my-2 md:my-0 border-t border-r p-4 md:p-0 md:w-1/3 md:border-0 md:rounded-none">
                    <p className="dark:text-white text-primary-800 text-2xl leading-10">
                        My projects often feature dynamic dashboards,
                        interactive charts, and responsive layouts, reflecting
                        my commitment to delivering exceptional user
                        experiences. What sets me apart is not just my technical
                        expertise, but also my strong communication skills.
                    </p>
                </div>
            </div>
            <div
            ...
            >
                ...
                <h2
                    className={`text-primary-500/85 text-center text-lg sm:text-2xl`}
                >
                    -AB
                </h2>
            </div>
